...
> 关于 JS 类型转换规则请看上一篇的内容：[掌握 JS 类型转换：从规则开始](https://github.com/deepfunc/js-bullshit-blog/issues/2)
...
上一篇写了 [JS 类型转换的规则](https://github.com/deepfunc/js-bullshit-blog/issues/2)，这一篇写了隐式转换中我总结的经验和判断法则。感觉已经差不多了，剩下的就是实践中自己去理解了，后续可能还会找一些比较坑的类型转换示例代码写一篇拆解分析。

感谢大家花时间听我比比，欢迎 star 和关注我的 JS 博客：[小声比比 Javascript](https://github.com/deepfunc/js-bullshit-blog)
